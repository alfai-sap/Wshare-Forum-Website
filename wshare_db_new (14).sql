...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2024 at 06:36 PM
...
(24, 3, 'test owner', 'sdsadsad', 'community_thumbs/6617357.jpg', '2024-11-22 07:20:27', 'private'),
...
--
ALTER TABLE `comments`
  MODIFY `CommentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=130;
...
--
ALTER TABLE `replies`
  MODIFY `ReplyID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
